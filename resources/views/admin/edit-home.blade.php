...
<div id="edit_home">
    ...
    <div class="add-ads">
        <label for="categories" class="d-block mb-2">الاعلانات</label>
        <div>
            <div class="pc_ads">
                <div class="ad_wrapper">
                    <label class="ad" for="ad_1">
                        <img v-if="imagePreview_ad_1" :src="imagePreview_ad_1" alt="">
                        الاعلان #1 بالطول
                        (هذا الاعلان يظهر في صفحة المقال التفصيلية)
                    </label>
                    <input type="file" name="ad_1" id="ad_1" v-model="ad_1" @change="handleFileChange(1, 1)">
                </div>
                <div class="ad_wrapper">
                    <label class="ad" for="ad_2">
                        <img v-if="imagePreview_ad_2" :src="imagePreview_ad_2" alt="">
                        الاعلان #2 بالطول
                    </label>
                    <input type="file" name="ad_2" id="ad_2" v-model="ad_2" @change="handleFileChange(2, 2)">
                </div>
                <div class="ad_wrapper">
                    <label class="ad" for="ad_3">
                        <img v-if="imagePreview_ad_3" :src="imagePreview_ad_3" alt="">
                        الاعلان #3 بالطول
                    </label>
                    <input type="file" name="ad_3" id="ad_3" v-model="ad_3" @change="handleFileChange(3, 3)">
                </div>
            </div>
            <div class="mobile_ads">
                <div class="ad_wrapper">
                    <label class="ad" for="mobile_ad_1">
                        <img v-if="imagePreview_mobile_ad_1" :src="imagePreview_mobile_ad_1" alt="">
                        الاعلان #1 بالعرض
                        (هذا الاعلان يظهر في صفحة المقال التفصيلية)
                    </label>
                    <input type="file" name="mobile_ad_1" id="mobile_ad_1" v-model="mobile_ad_1" @change="handleMobileFileChange(1, 1)">
                </div>
                <div class="ad_wrapper">
                    <label class="ad" for="mobile_ad_2">
                        <img v-if="imagePreview_mobile_ad_2" :src="imagePreview_mobile_ad_2" alt="">
                        الاعلان #2 بالعرض
                    </label>
                    <input type="file" name="mobile_ad_2" id="mobile_ad_2" v-model="mobile_ad_2" @change="handleMobileFileChange(2, 2)">
                </div>
                <div class="ad_wrapper">
                    <label class="ad" for="mobile_ad_3">
                        <img v-if="imagePreview_mobile_ad_3" :src="imagePreview_mobile_ad_3" alt="">
                        الاعلان #3 بالعرض
                    </label>
                    <input type="file" name="mobile_ad_3" id="mobile_ad_3" v-model="mobile_ad_3" @change="handleMobileFileChange(3, 3)">
                </div>
            </div>
            <div class="main_ad">
                <div class="ad_wrapper">
                    <label class="ad" for="main_ad">
                        <img v-if="imagePreview_main_ad" :src="imagePreview_main_ad" alt="">
                        الاعلان الرئيسي
                    </label>
                    <input type="file" name="main_ad" id="main_ad" v-model="main_ad" @change="handlemain_adFileChange()">
                </div>
            </div>
        </div>
    </div>

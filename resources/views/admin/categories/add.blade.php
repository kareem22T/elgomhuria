...
<div id="add_cat">
    <div>
        <div>
            ...
            <div class="w-100 mb-3 d-flex gap-4">
                ...
                <div class="w-25">
                    <div for="thumbnail" class="w-100 h-100 p-3 d-flex justify-content-center align-items-center form-control input" style="max-height: 170px;" @click="this.showImages = true">
            ...
            <div  class="d-flex justify-content-between gap-4 align-items-end flex-wrap-wrap">
                <div class="w-50">
                    <label for="symbol" class="form-label">نوع القسم *</label>
                    <select name="cat_type" id="cat_type" class="form-control" @change="chooseCatType(this.cat_type)" placeholder="fjasdj" v-model="cat_type" placeholder="---">
                ...
                <button type="submit" class="btn btn-primary w-50 form-control button" style="height: fit-content" @click="add(category_translations, main_name, description, cat_type, main_cat_id, choosed_img)"><i class="ti ti-plus"></i> اضافة القسم</button>
            </div>
        </div>
    </div>
</div>
